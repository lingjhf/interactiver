...
/**
   ...
   */
export function calcThumbWidth(viewWidth: number, contentWidth: number): number {
...
/**
   ...
   */
export function calcThumbX(scrollX: number, thumbWidth: number, viewWidth: number, contentWidth: number): number {
...
/**
   ...
   */
export function calcScrollX(thumbX: number, thumbWidth: number, viewWidth: number, contentWidth: number): number {
